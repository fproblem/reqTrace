...
⚠ Координатное пространство: как и раньше, все координаты — по DOM
ОБРАБОТАННОГО HTML (см. предупреждение в highlight_projection.py): сырой
storage-XML даёт другую разбивку на блоки.
