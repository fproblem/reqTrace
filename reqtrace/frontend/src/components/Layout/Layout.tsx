    ...
    <div style={{
      ...
      <header style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', flexShrink: 0 }}>
          ...
          {/* Проба ширины скроллбара. <main> резервирует место под скроллбар
              (scrollbar-gutter: stable), и в классическом режиме macOS
              («показывать полосы всегда» или подключена мышь) весь контент
              страницы — включая её верхний бар — стоит левее на ширину полосы
              (~15px). Шапка живёт вне скроллера, и «Выйти» переставала быть в
              одной вертикали с «⋮», а профиль — над переключателем режимов.
              Пустой блок с overflow-y: scroll получает интринзик-ширину ровно
              в классический скроллбар (в overlay-режиме — 0), т.е. шапка
              сдвигается синхронно с контентом при любой системной настройке
              и без JS-замеров. visibility: hidden прячет пустую полосу, но
              сохраняет место; отрицательный маргин гасит gap кластера, чтобы
              в overlay-режиме проба давала ровно 0. */}
          <div
            aria-hidden
            style={{
              overflowY: 'scroll',
      ...
      <div style={{ display: 'flex', flex: 1, minHeight: 0, position: 'relative', zIndex: 1 }}>
        ...
        {/* scrollbar-gutter: место под скроллбар зарезервировано всегда —
            ...
            системной настройке «показывать полосы всегда»). Ту же ширину
            зеркалит проба в правом кластере шапки — см. комментарий там. */}
        <main style={{
