  ...
  return (
    <div
      ...
      style={{
        ...
        // Именно overflow-wrap, НЕ word-break: break-word — тот в Chrome
        // обнуляет min-content текста, и авто-раскладка таблиц сплющивала
        // соседние колонки до «по букве в строке», когда колонке с крупным
        // содержимым (вложенные таблицы со скриншотами) не хватало места
        // (репро v1.7.3: «Деталка заказа»). overflow-wrap переносит длинное
        // слово так же, но min колонки остаётся равным самому длинному слову:
        // тесной таблице честно не хватает ширины, и она целиком уезжает в
        // горизонтальный скролл .table-scroll — ячейки не скроллятся никогда.
