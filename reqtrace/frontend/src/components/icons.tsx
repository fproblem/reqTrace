...
/** Клипборд с галочкой — тест-кейсы: кнопка раздела «Тесты» в шапке
 *  приложения и будущие места про тестовое покрытие. */
...
/** Двойная кавычка-«апостроф» (❝) — маркер дословной цитаты. Залитая, а не
 *  контурная: на мелких размерах (~14px) обводка двух хвостатых знаков
 *  превращается в кашу. Цвет — через `color` родителя (fill=currentColor). */
