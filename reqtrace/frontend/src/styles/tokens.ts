...
export const island = {
  ...
  // виртуальной, заглушка «/») чуть приподнята — «рабочая поверхность ближе
  // к читателю». Глубже card, спокойнее panel.
  boxShadowRaised: '0 4px 16px rgba(0, 0, 0, 0.06), 0 1px 3px rgba(0, 0, 0, 0.05)',
} as const;
